...
{
    public partial class PayrollManagementSystemMVCContextMVC : DbContext
    {
        public PayrollManagementSystemMVCContextMVC()
        {
        }

        public PayrollManagementSystemMVCContextMVC(DbContextOptions<PayrollManagementSystemMVCContextMVC> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<EmployeeMasterMVC> EmployeeMasters { get; set; }
        public virtual DbSet<HalfWorkingDaysCountMVC> HalfWorkingDaysCounts { get; set; }
        public virtual DbSet<HalfWorkingDaysTimesheetMVC> HalfWorkingDaysTimesheets { get; set; }
        public virtual DbSet<LeaveDetail> LeaveDetails { get; set; }
        public virtual DbSet<LeaveMaster> LeaveMasters { get; set; }
        public virtual DbSet<LeaveTypeMVC> LeaveTypes { get; set; }
        public virtual DbSet<LoginTableMVC> LoginTables { get; set; }
        public virtual DbSet<PayrollDetail> PayrollDetails { get; set; }
        public virtual DbSet<PayrollMasterMVC> PayrollMasters { get; set; }
        public virtual DbSet<TimeSheetMVC> TimeSheets { get; set; }
        public virtual DbSet<WorkingDaysTimesheetMVC> WorkingDaysTimesheets { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployeeMasterMVC>(entity =>
            {
                entity.HasKey(e => e.EmployeeId)
            ...
            modelBuilder.Entity<HalfWorkingDaysCountMVC>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<HalfWorkingDaysTimesheetMVC>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<LeaveTypeMVC>(entity =>
            {
            ...
            modelBuilder.Entity<LoginTableMVC>(entity =>
            {
                entity.HasKey(e => e.EmployeeId);
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasForeignKey<LoginTableMVC>(d => d.EmployeeId)
            ...
            modelBuilder.Entity<PayrollMasterMVC>(entity =>
            {
                entity.HasKey(e => e.EmployeeId);
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasForeignKey<PayrollMasterMVC>(d => d.EmployeeId)
                    .HasConstraintName("FK__Payroll_M__Emplo__4AB81AF0");
            });

            modelBuilder.Entity<TimeSheetMVC>(entity =>
            {
            ...
            modelBuilder.Entity<WorkingDaysTimesheetMVC>(entity =>
            {
                entity.HasNoKey();
